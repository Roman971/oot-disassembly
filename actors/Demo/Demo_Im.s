...
func_809739E8:
    ...
    beq     $zero, $zero, lbl_80973A60
    or      v0, v1, $zero              # v0 = 00000000
lbl_80973A60:
    slti    $at, v0, 0x18E3
    beq     $at, $zero, lbl_80973A74
    nop
    beq     $zero, $zero, lbl_80973A74
...
func_80975394:
    ...
    or      a0, s0, $zero              # a0 = 00000000
    beq     $zero, $zero, lbl_80975448
    sw      a2, 0x0264(s0)             # 00000264
lbl_80975404:
    jal     func_80975284
    sw      a2, 0x0020($sp)
    beq     $zero, $zero, lbl_80975444
    lw      a2, 0x0020($sp)
lbl_80975414:
    lw      a1, 0x002C($sp)
    jal     func_80975298
...
func_80975D7C:
    ...
    nop
    beq     $zero, $zero, lbl_80975DF8
    sw      a2, 0x0264(a0)             # 00000264
lbl_80975DD0:
    jal     func_80975C84
    sw      a2, 0x0018($sp)
    lw      a2, 0x0018($sp)
    beq     $zero, $zero, lbl_80975DF4
    lw      a0, 0x0020($sp)
lbl_80975DE4:
    jal     func_80975D08
    sw      a2, 0x0018($sp)
