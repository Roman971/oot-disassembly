...
lbl_8093B420:
    ...
    sub.s   $f8, $f4, $f6
    beq     $zero, $zero, lbl_8093B488
    swc1    $f8, 0x0054(s0)            # 00000054
lbl_8093B440:
    jal     func_80020EB4
    or      a0, s0, $zero              # a0 = 00000000
    beq     $zero, $zero, lbl_8093B48C
    lw      $ra, 0x0024($sp)
lbl_8093B450:
    beq     $zero, $zero, lbl_8093B488
