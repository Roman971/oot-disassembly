...
func_80B03F1C:
    ...
    or      a0, s0, $zero              # a0 = 00000000
    beq     $zero, $zero, lbl_80B04140
    nop
lbl_80B04110:
    jal     func_80AFF230
    lw      a1, 0x0034($sp)
    beq     $zero, $zero, lbl_80B0414C
    lw      $ra, 0x0024($sp)
lbl_80B04120:
    jal     func_80AFFA14
    lw      a1, 0x0034($sp)
...
func_80B0421C:
    ...
    or      a0, s0, $zero              # a0 = 00000000
    beq     $zero, $zero, lbl_80B042CC
    lw      $ra, 0x002C($sp)
lbl_80B042B4:
    lui     $at, 0x8012                # $at = 80120000
    beq     $zero, $zero, lbl_80B042C8
