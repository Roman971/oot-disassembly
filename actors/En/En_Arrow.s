...
lbl_80884A48:
    ...
    bc1fl   lbl_80884A7C               
    mov.s   $f0, $f2                   
    beq     $zero, $zero, lbl_80884A7C 
    mov.s   $f0, $f12                  
    mov.s   $f0, $f2                   
lbl_80884A7C:
    add.s   $f6, $f0, $f4              
    lw      t4, 0x023C(s0)             # 0000023C
    beq     $zero, $zero, lbl_80884A9C 
